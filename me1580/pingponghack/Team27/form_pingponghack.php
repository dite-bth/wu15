...
include "pingponghack_register.php";
session_start(); //Varje sida som har en session måste använda denna metod.
...
<!--BOOTSTRAP-->
	...
	<script type="text/javascript" src="script_pingponghack.js"></script>
